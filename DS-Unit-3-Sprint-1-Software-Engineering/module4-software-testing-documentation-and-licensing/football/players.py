...
class DefensivePlayer(Player):
    '''Override certain paramters of the default Player class and add some
    functionality unique to defensive players
    '''
    def __init__(self, name=None, yards=20, touchdowns=None, safety=None,
                 interceptions=1, field_goals=None, sacks=2, tackles=12):
        super().__init__(name=name, yards=yards, touchdowns=touchdowns,
                         safety=safety, interceptions=interceptions)
